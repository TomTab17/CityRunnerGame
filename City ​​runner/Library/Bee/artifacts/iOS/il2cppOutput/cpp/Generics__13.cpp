...
{
	{
		...
		L_0 = Dictionary_2_get_Keys_m0F7A56173EB54BEE442082D54AD3086AA824DFF2(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 58));
		return (RuntimeObject*)L_0;
	}
}
...
{
	{
		...
		L_0 = Dictionary_2_get_Values_m1D643B08EBBB9651BAD368057C86AB6FC3ED5DC4(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 59));
		return (RuntimeObject*)L_0;
	}
}
